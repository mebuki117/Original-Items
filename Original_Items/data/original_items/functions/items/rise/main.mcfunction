...
### replace the item
execute as @a[scores={origitem_click=1},tag=!origitem_rise_2] run replaceitem entity @s weapon air

### add temp tag 2
execute as @a[scores={origitem_click=1},tag=!origitem_rise_2] run tag @s add origitem_rise_2
